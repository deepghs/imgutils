...
print_version = partial(_origin_print_version, 'zoo.manbits_detect')
...
def export(output_dir: str):
    for ckpt in tqdm(_KNOWN_CKPTS):
        yolo = YOLO(hf_hub_download('deepghs/imgutils-models', f'manbits_detect/{ckpt}'))
